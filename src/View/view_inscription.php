                ...
                <div class="card p-4">
                    ...
                    <form action="" method="POST" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?php echo isset($errors['prenom']) ? 'is-invalid' : ''; ?>" id="prenom" name="prenom" value="<?= $_POST['prenom'] ?? '' ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control <?php echo isset($errors['pseudo']) ? 'is-invalid' : ''; ?>" id="pseudo" name="pseudo" value="<?= $_POST['pseudo'] ?? '' ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control <?php echo isset($errors['email']) ? 'is-invalid' : ''; ?>" id="email" name="email" value="<?= $_POST['email'] ?? '' ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control <?php echo isset($errors['dob']) ? 'is-invalid' : ''; ?>" id="dob" name="dob" value="<?= $_POST['dob'] ?? '' ?>" required>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control <?php echo isset($errors['genre']) ? 'is-invalid' : ''; ?>" id="genre" name="genre" required>
                                <option value="" disabled <?php echo !isset($_POST['genre']) ? 'selected' : ''; ?>>-- Choisir --</option>
