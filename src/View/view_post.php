      ...
      <div class="col-9">
        <div class="mt-3 mx-auto w-50">
          <div class="bg-dark text-light p-4 shadow rounded">
            ...
            <form action="../../src/Controller/controller_post.php" method="POST" enctype="multipart/form-data"
              novalidate>
              <div class="row g-2 justify-content-center">
                ...
                <a href="../../src/Controller/controller_home.php" class="btn btn-primary mt-3 w-100">Post</a>
                <div class="col-12">
                  <a href="../../src/Controller/controller_home.php" class="btn btn-outline-secondary w-100">Cancel</a>
                </div>
              </div>
            </form>
          </div>
